...
trait BaseControllersSpec extends FlatSpec
  ...
  it should "load styles assets generated by webpack" in {
    //given
    val request = wsUrl(s"$baseUrl/assets/styles/scommons-examples-$exampleId-opt.css")
  ...
  it should "load javascript assets generated by webpack" in {
    //given
    val request = wsUrl(s"$baseUrl/assets/scommons-examples-$exampleId-opt.js")
  ...
  it should "load index.html page" in {
    ...
    pageSource should include (s"$baseUrl/assets/styles/scommons-examples-$exampleId-opt.css")
    pageSource should include (s"$baseUrl/assets/scommons-examples-$exampleId-opt-library.js")
    pageSource should include (s"$baseUrl/assets/scommons-examples-$exampleId-opt-loader.js")
    pageSource should include (s"$baseUrl/assets/scommons-examples-$exampleId-opt.js")
  }
}
